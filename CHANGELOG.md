...
- Fixed the grid component to properly show the top scroll bar when needed due to the window resizing. [#101](https://github.com/blackbaud/skyux-grids/pull/101)
